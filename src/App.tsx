...
const App: React.FC = () => {
  ...
  // Estados do SupportWidget inline
  ...
  // Fecha o painel de suporte ao clicar fora
  useEffect(() => {
      ...
      `}>
        ...
        <div className="flex items-center gap-3 px-6 h-24 border-b border-slate-800">
          <div className="w-8 h-8 bg-[#1A73E8] rounded-lg flex items-center justify-center shadow-md">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="MapsGuru">
        ...
        <div className="px-4 py-6 flex-1 overflow-y-auto">
          ...
          <nav className="space-y-1">
            ...
            {/* SUPORTE & FEEDBACK integrado no sidebar */}
            <div ref={supportRef} className="relative">
              <button
                onClick={() => { setSupportOpen(!supportOpen); setShowFeedbackForm(false); }}
                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all text-slate-400 hover:text-white hover:bg-slate-800"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="absolute bottom-full left-0 mb-2 w-72 bg-white rounded-2xl shadow-2xl p-4 z-50 border border-slate-200">
                  ...
                  <div className="space-y-2">
                    <button
                      ...
                      className="w-full bg-green-500 hover:bg-green-600 text-white p-3 rounded-xl transition-all flex items-center gap-3"
                    >
                      ...
                      <div className="text-left">
                        <p className="text-sm font-bold">Falar no WhatsApp</p>
                        <p className="text-xs opacity-80">Resposta rápida e direta</p>
                      </div>
                    </button>

                    <button
                      onClick={() => setShowFeedbackForm(true)}
                      className="w-full bg-slate-100 hover:bg-slate-200 p-3 rounded-xl transition-all flex items-center gap-3"
                    >
                      ...
                      <div className="text-left">
                        <p className="text-sm font-bold text-gray-800">Enviar Feedback</p>
                        <p className="text-xs text-gray-500">Bug, sugestão ou dúvida</p>
                      </div>
                    </button>
                  </div>
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <select
                            ...
                            className="w-full px-3 py-2 bg-slate-100 rounded-xl text-gray-800 text-sm focus:outline-none"
                          >
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            rows={3}
                            className="w-full px-3 py-2 bg-slate-100 rounded-xl text-gray-800 text-sm placeholder-gray-400 focus:outline-none resize-none"
                          />
                        </div>
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="flex-1 px-3 py-2 bg-slate-100 hover:bg-slate-200 text-gray-700 text-sm font-bold rounded-xl transition-all"
                          >
                            Cancelar
                          </button>
                          <button
                            ...
                            className={`flex-1 px-3 py-2 text-sm font-bold rounded-xl transition-all flex items-center justify-center gap-1 ${
        ...
        <header className="h-20 bg-white/90 backdrop-blur-md border-b border-slate-200 flex items-center justify-between px-6 sticky top-0 z-10 shadow-sm transition-all">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 md:w-12 md:h-12 bg-[#1A73E8] rounded-xl flex items-center justify-center shadow-md transition-all">
              <svg width="24" height="24" className="md:w-7 md:h-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="MapsGuru">
                <path d="M12 2C7.86 2 4.5 5.36 4.5 9.5C4.5 14.47 12 22 12 22C12 22 19.5 14.47 19.5 9.5C19.5 5.36 16.14 2 12 2Z" fill="white" />
                <path d="M12 7.2L13.09 9.41L15.53 9.76L13.76 11.48L14.18 13.9L12 12.75L9.82 13.9L10.24 11.48L8.47 9.76L10.91 9.41L12 7.2Z" fill="#FBBC05" />
              </svg>
            </div>
