...
export const BusinessProfile: React.FC = () => {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      formData.append('upload_preset', 'zmaps_business_avatars');
      formData.append('folder', 'business-avatars');
      
      const response = await fetch(
        'https://api.cloudinary.com/v1_1/dn3mptdgl/image/upload',
        {
          method: 'POST',
          body: formData
        }
      ...
      setProfile(prev => ({ ...prev, businessAvatar: imageUrl }));
