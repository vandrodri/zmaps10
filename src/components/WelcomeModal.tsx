    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-[9999] flex items-center justify-center p-4 animate-fade-in">
      <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-8 relative animate-scale-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
          <div className="bg-purple-50 p-4 rounded-xl border border-purple-200 transition-all hover:shadow-md">
          ...
          <div className="bg-green-50 p-4 rounded-xl border border-green-200 transition-all hover:shadow-md">
            <div className="flex items-center gap-3 mb-2">
          ...
          <div className="bg-cyan-50 p-4 rounded-xl border border-cyan-200 transition-all hover:shadow-md">
            <div className="flex items-center gap-3 mb-2">
          ...
          <div className="bg-orange-50 p-4 rounded-xl border border-orange-200 transition-all hover:shadow-md">
            <div className="flex items-center gap-3 mb-2">
